...
genPDG         = 553 # Generated Particle PDG ID (only needed for MC), Jpsi: 443 , Psi(2S): 100443, Upsilon(1S): 553 , Upsilon(2S): 100553 , Upsilon(2S): 200553
...
#options.inputFiles = 'file:onia2MuMuPAT_MC_80X.root'
options.inputFiles = 'file:step2_ChiBToUps1SG_8p16TeV_TuneCUETP8M1_AOD_915.root'
#options.inputFiles = '/store/user/jaebeom/step2_ChiBToUps1SG_8p16TeV_TuneCUETP8M1_RECOAOD_v2/ChiBToUps1SG_8p16TeV_TuneCUETP8M1_GENSIM_v2/step2_ChiBToUps1SG_8p16TeV_TuneCUETP8M1_RECOAOD_v2/200717_093623/0000/step2_ChiBToUps1SG_8p16TeV_TuneCUETP8M1_AOD_915.root'
...
process.hionia = cms.EDAnalyzer('HiOniaAnalyzer',
                                #-- Collections
    		                        srcConversion       = cms.InputTag("allConversions"),             # Name of Reco Conversion Collection
