...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
      "file:/afs/cern.ch/work/j/jaebeom/private/Analysis/PhotonV2/CMSSW_10_3_3_patch1/src/HeavyIonsAnalysis/JetAnalysis/test/006745A8-5CCE-A946-BF24-BC13E84B229C.root"
...
process.load('RecoHI.HiJetAlgos.hiFJRhoFlowModulationProducer_cff')
process.hiFJRhoFlowModulationProducer.doFlatTest = cms.bool(True)
